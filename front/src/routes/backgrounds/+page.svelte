...
<PageCard
	title="Backgrounds"
	description="Upload custom background images for your dashboard. Drag & drop or click empty slots to upload. Supported format: PNG. After uploading, click the Sync button below to transfer images to your Digital Dash."
	icon={ImageIcon}
>
