#ifndef USER_IMAGES_H
#define USER_IMAGES_H
 ...
 */
esp_err_t user_images_list_handler(httpd_req_t *req);
 ...
 * @return ESP_OK on success, ESP_FAIL otherwise.
 */
esp_err_t user_image_get_handler(httpd_req_t *req);
 ...
 * @return ESP_OK on success, ESP_FAIL otherwise.
 */
esp_err_t user_image_post_handler(httpd_req_t *req);
